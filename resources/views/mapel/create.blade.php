                        ...
                        <div class="animated fadeIn">  
                                <div class="card-header"> 
                                    <table width="100%"  class="fa fa-text-height" aria-hidden="true"   border="0" cellpadding="0" cellspacing="0"   class="fa fa-align-center" > 
                                        <tr>
                                         <td><h5 class="card-title">Tambah mapel</span></h5></td>
                                         <td> 
                                            ...
                                            <form action="{{ url('mapel')}}" method="post" enctype="multipart/form-data">
                                                  ...
                                                  <p>
                                                    <div class="row mb-3"> 
                                                        ...
                                                        <div class="col-sm-10">
                                                          <input type="text" class="form-control @error('kd_mapel') is-invalid @enderror"   value="{{ old('kd_mapel') }}"  name="kd_mapel"  required autofocus>
                                                           </div>
                                                      </div> 

                                                      <div class="row mb-3"> 
                                                        <label for="name" class="col-sm-2 col-form-label">Nama mata pelajaran</label>
                                                        <div class="col-sm-10">
                                                          <input type="text" class="form-control @error('nama_pel') is-invalid @enderror"   value="{{ old('nama_pel') }}"  name="nama_pel"  required autofocus>
                                                           </div>
                                                      </div> 
