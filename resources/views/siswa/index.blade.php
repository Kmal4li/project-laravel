                  ...
                  <div class="content mt-3">
                      ...
                      <div class="card-header"> 
                                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                        <tr>
                                          <td><h5 class="card-title">Data Siswa</span></h5></td>
                                          <td> 
                                            <div align="right">   
                                              <a href="{{ url('siswa/show')}}"  class="btn btn-success btn-sm"  role="button" aria-disabled="true">
                                  ...
                                  <table class="table table-borderless datatable">
                                              ...
                                              <tbody>
                                                ...
                                                <tr>
                                                        ...
                                                        <td>{{$item -> kelas}}</td> 
                                                        <td>{{$item -> alamat}}</td> 
                                                        <td><a href="{{ url('siswa/' .$item->nis.'/edit')}}" class="btn btn-success btn-sm" >
                                                        <span class="bi bi-pencil-square" style="font-size:12px"></span></a></td>
                                                        <td>
                                                        <form action="{{ url('siswa/' .$item->nis)}}" method="post" class="d-inline" onsubmit="return confirm('Yakin Hapus Data')">
                                                                @method('delete')
                                                                @csrf
