                        ...
                        <div class="animated fadeIn">  
                                <div class="card-header"> 
                                    <table width="100%"  class="fa fa-text-height" aria-hidden="true"   border="0" cellpadding="0" cellspacing="0"   class="fa fa-align-center" > 
                                        <tr>
                                         <td><h5 class="card-title">Ubah Data Nilai</span></h5></td>
                                         <td> 
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="card-body">  
                                            <form action="{{ url('nilai/'.$nilai->nis)}}" method="post" enctype="multipart/form-data">
                                                  ...
                                                  <p>
                                                    <div class="row mb-3"> 
                                                      ...
                                                      <div class="row mb-3"> 
                                                        ...
                                                        <div class="col-sm-10">
                                                          <input type="text" class="form-control" value="{{ old('nilai_harian',$nilai->nilai_harian) }}"  name="nilai_harian" required autofocus>
                                                           </div>
                                                      </div> 
                                                      ...
                                                      <div class="row mb-3">
                                                        ...
                                                        <div class="col-sm-10">
                                                          <input type="text" class="form-control"  value="{{ old('nilai_pts',$nilai->nilai_pts) }}"  name="nilai_pts"  required autofocus>
                                                           </div>
                                                      </div> 
                                                      ...
                                                      <div class="row mb-3">
                                                        ...
                                                        <div class="col-sm-10">
                                                          <input type="text" class="form-control"  value="{{ old('nilai_akhir',$nilai->nilai_akhir) }}"  name="nilai_akhir"  required autofocus>
                                                           </div>
                                                      </div> 
